...
<div class="ad-container">
  <div class="ad-header">
    ...
    <p class="ad-desc">Welcome quality brands and products for advertising cooperation</p>
  </div>
    ...
    <div class="contact-cards">
      <a class="contact-card" href="https://mp.weixin.qq.com/s/S1sq45LC_iQuCLYxzoaRkw" target="_blank" rel="external nofollow">
        ...
        <div class="contact-info">
          <h3>WeChat</h3>
          <p>Click to view Official Account</p>
        </div>
      </a>
    </div>
  </div>
...
var adPositions = [
  ...
  { avatar: '/images/logo.png', url: 'http://b.lyc.la', name: 'Blog' }
];
